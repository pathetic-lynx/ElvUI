...
L["Player"] = true
L["Swing Bar"] = true
L["Swing Bar (Secondary)"] = true
L["Player SwingBar"] = true
L["Player SwingBar (Secondary)"] = true
...
L["Melee"] = true
L["Ranged"] = true
L["Which attack type this bar follows. Set the two bars to Melee and Ranged to watch both at once (e.g. a hunter)."] = true
L["Center Fill"] = true
L["Fill outward from the center toward both edges instead of end to end."] = true
L["Shot Point"] = true
L["Where the swing lands on a center-filling bar."] = true
L["Outside"] = true
L["Middle"] = true
L["Either"] = true
L["Small"] = true
