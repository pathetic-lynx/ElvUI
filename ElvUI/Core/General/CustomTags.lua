...
--WoW API
-- IsInGroup/IsInRaid are not native in 3.3.5; use ElvUI's LibCompat shims
...
-- NOTE: "faction:icon" is intentionally omitted; ElvUI already provides it (Core/General/Tags.lua)
